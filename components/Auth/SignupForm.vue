...
<div class="bg-gray-100 flex justify-center items-center h-svh mt-[-120px]">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-96" @submit="onSubmit">
        ...
        <div class="mb-4">
            ...
            <div class="text-xs text-red-hover min-h-4">{{ errors.username }}</div>
        </div>
        <div class="mb-4">
            ...
            <div class="text-xs text-red-hover min-h-4">{{ errors.email }}</div>
        </div>
        <div class="mb-4">
            ...
            <div class="text-xs text-red-hover min-h-4">{{ errors.password }}</div>
        </div>  
        <div class="flex items-center justify-between">
            <button class="bg-lime-green-100 hover:bg-lime-green-200 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer">Cоздать аккаунт</button>
